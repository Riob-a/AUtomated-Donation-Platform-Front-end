          ...
          <div className="col-md-4 mb-3">
            <div className="card w-100 text-bg-secondary rounded-5">
              <div className="card-body">
                ...
                <br />
                <Link to="/applications" className="btn btn-dark m-2 rounded-pill">Go to Applications</Link>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-4 mb-3">
            <div className="card w-100 text-bg-secondary rounded-5">
              <div className="card-body">
                ...
                <br />
                <Link to="/admin_charities" className="btn btn-dark m-2 rounded-pill">Go to Charities</Link>
                <Link to="/admin_beneficiaries" className="btn btn-dark  rounded-pill m-2">Go to Beneficiaries</Link>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-4 mb-3">
            <div className="card w-100 text-bg-secondary rounded-5">
              <div className="card-body">
                ...
                <br />
                <Link to="/admin_register" className="btn btn-dark  rounded-pill m-2">Register Admin</Link>
              </div>
            </div>
          </div>
        </div> 
        <div>
          <Link to="/home" className="btn btn-warning rounded-pill m-4">Go To Home</Link>
        </div>
      </div>
    </div>
  );
